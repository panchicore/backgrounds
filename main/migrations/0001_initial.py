...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Bound'
        db.create_table('main_bound', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bounds', to=orm['auth.User'])),
        ...
        db.send_create_signal('main', ['Bound'])


    def backwards(self, orm):
        
        # Deleting model 'Bound'
        db.delete_table('main_bound')
